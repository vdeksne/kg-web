...
/** Compact phones only (≤400px). Wider viewports use desktop hero art + chrome. */
    ...
    >
      ...
      */}
      ...
      >
        ...
        >
          <div
            className="pointer-events-none absolute right-0 bottom-0 z-0 hidden min-[401px]:block bg-contain bg-no-repeat"
            style={{
              left: HERO_CONTENT_X,
          ...
          <div className="relative z-10 flex h-full min-h-0 w-full flex-col max-[400px]:pt-[calc(50px+3.5rem+env(safe-area-inset-top))] px-[clamp(1.5rem,calc(var(--hero-vw)*202/1920),202px)]">
            ...
            <div
              className="pointer-events-none absolute top-0 bottom-0 left-0 z-30 hidden min-[401px]:flex min-[401px]:overflow-visible min-[401px]:right-[clamp(1.5rem,calc(var(--hero-vw)*202/1920),202px)] min-[401px]:items-center min-[401px]:justify-end min-[401px]:pt-0"
              aria-hidden
            >
              <div
            ...
            <div className="grid flex-1 gap-10 pt-10 max-[400px]:pt-6 lg:items-center lg:pt-0">
              <div className="relative flex min-h-0 flex-col items-start justify-center text-left max-[400px]:min-h-[42vh] lg:min-h-[753px]">
                <div
            ...
            <div
              className="mt-auto hidden min-[401px]:flex w-full items-end gap-3 pt-16 lg:pt-10"
              style={{

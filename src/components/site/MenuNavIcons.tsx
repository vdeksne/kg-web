...
/**
 * EN menu wordmarks use `<text>`; LV uses stroked paths (~0.32). Weight 500 read heavier than LV,
 * so use normal/book to match the black path wordmarks.
 */
const engNavMenuTextWeight = 400;

/** Thickens LV path lettering only; accent bars are separate `<rect>` elements. */
const lvInkAttrs = {
...
const menuNavIconLvSvgClass = "h-[1em] w-auto shrink-0 overflow-visible";
    ...
    return (
      ...
      >
        ...
        <text
          fill="currentColor"
          fontSize="24"
          fontWeight={engNavMenuTextWeight}
